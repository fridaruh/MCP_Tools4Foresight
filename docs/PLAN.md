...
> Fuente única de verdad para todos los sub-agentes. Si este documento y el código
> divergen, gana este documento hasta que alguien lo actualice a propósito.

Dos repos involucrados:
- **Fuente**: `/Users/fridaruh/Documents/Proyectos/x-likes-curator` (Next.js 16, Prisma 7, Neon+pgvector). Aquí se crea la API pública read-only.
- **Nuevo**: `/Users/fridaruh/Documents/Proyectos/MCP_Tools4Foresight` (TypeScript, MCP SDK). Aquí vive el servidor MCP.
