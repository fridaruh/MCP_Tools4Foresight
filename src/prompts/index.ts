 ...
 */
const DOMAIN_RULES = [
  "Reglas del mapa de foresight de tools4foresight (respétalas al redactar):",
  "",
  ...
  "- El grafo cubre solo señales publicadas: es la vista curada, no el catálogo completo.",
