/**
 * Tools de taxonomía y estado del acervo (#12, #13 y #17 del catálogo,
 * docs/PLAN.md §2.6).
 *
  ...
  const lines = [
    ...
    `- **Rango de fechas** (\`likedAt\`, estimado): ${
      dateRange.earliestLikedAt && dateRange.latestLikedAt
        ...
        : "sin señales publicadas todavía"
    }`,
  ...
  server.registerTool(
    "list_pestel_dimensions",
    {
      ...
      description:
        ...
        "conteos puede superar el total de señales publicadas — eso es esperado, no una inconsistencia.",
      inputSchema: {},
      annotations: READ_ONLY,
    },
    guarded(async () => {
