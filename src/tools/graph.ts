 ...
 *
 * El grafo es la vista CURADA: solo señales publicadas, nodos y aristas
 * (similitud coseno >= 0.55). Es la representación cruda de la que salen los
...
export function registerGraphTools(server: McpServer, ctx: ToolContext): void {
  server.registerTool(
    'get_graph',
    {
      ...
      description:
        'El grafo semántico completo (nodos + aristas) de las señales publicadas: es la vista CURADA de la ' +
